...
const navigation = [
  ...
  { name: 'Students', href: '/admin/students', icon: Users, count: null },
  { name: 'Programs', href: '/admin/programs', icon: GraduationCap, count: null },
  { name: 'Events', href: '/admin/events', icon: Calendar, count: null },
  { name: 'Documents', href: '/admin/documents', icon: FileText, count: null },
  { name: 'Financial', href: '/admin/financial', icon: DollarSign, count: null },
  { name: 'Communication', href: '/admin/communication', icon: MessageSquare, count: null },
  ...
  { name: 'Demo Data', href: '/admin/demo-data', icon: Settings, count: null },
