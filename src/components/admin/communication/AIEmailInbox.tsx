    ...
    <div className="space-y-6">
        ...
        <ModernCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{highPriorityEmails.length}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          ...
                          <InfoBadge 
                            variant={email.ai_priority_score >= 90 ? 'destructive' : email.ai_priority_score >= 70 ? 'warning' : 'default'}
                          >
        ...
        <div className="lg:col-span-2">
          {selectedEmailData ? (
            <ModernCard className="h-[calc(100vh-400px)] flex flex-col">
              {/* Email Header */}
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {selectedEmailData.lead_match && (
                    <ModernCard className="bg-success-light/20 border-success/30">
                      <div className="p-4">
                        <div className="flex items-start justify-between gap-4">
