...
const defaultLayouts: Layout[] = [
  { i: 'personal-info', x: 0, y: 0, w: 6, h: 4, minW: 5, minH: 4 },
  { i: 'document-overview', x: 6, y: 0, w: 6, h: 5, minW: 5, minH: 5 },
  { i: 'program-details', x: 0, y: 5, w: 6, h: 4, minW: 5, minH: 4 },
  { i: 'intake-deadline', x: 6, y: 5, w: 6, h: 5, minW: 5, minH: 5 },
  { i: 'application-timeline', x: 0, y: 10, w: 12, h: 5, minW: 8, minH: 5 },
];
