...
import { Plus, Edit, Trash2, Eye, Star, FileText } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
...
export const InvoiceTemplateTable = () => {
              ...
              <TableBody>
                {templates.map((template) => (
                  <TableRow key={template.id}>
                    ...
                    <TableCell className="max-w-xs truncate">{template.subject_line}</TableCell>
                    <TableCell>
                      {template.is_default && (
