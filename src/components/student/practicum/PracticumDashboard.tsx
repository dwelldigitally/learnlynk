...
import { Clock, FileText, Award, ClipboardCheck, Plus, AlertCircle, CheckCircle, Calendar } from "lucide-react";
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {progress?.hours_approved || 0} / {progress?.hours_required || 0}
                  </span>
                </div>
                <Progress 
                  value={progress?.hours_required ? (progress.hours_approved / progress.hours_required) * 100 : 0} 
                  className="h-2" 
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {progress?.competencies_completed || 0} / {progress?.competencies_required || 0}
                  </span>
                </div>
                <Progress 
