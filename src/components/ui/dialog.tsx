    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          isMobile 
            ? "inset-x-2 top-2 bottom-2 max-h-[calc(100vh-1rem)] rounded-lg p-4 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
      ...
      >
        ...
        <DialogPrimitive.Close className={cn(
          ...
          isMobile ? "right-3 top-3 w-8 h-8 flex items-center justify-center" : "right-4 top-4"
        )}>
