    ...
    return [
      {
        ...
        withdrawal_deadline: '2025-11-14',
        status: 'active',
        is_current: true,
      ...
      },
      {
        ...
        user_id: 'demo-user',
        name: 'Winter 2026',
        description: 'Winter semester 2026',
        term_type: 'semester',
        academic_year: '2025-2026',
        start_date: '2026-01-05',
        end_date: '2026-04-24',
        registration_start_date: '2025-11-15',
        registration_end_date: '2025-12-15',
        add_drop_deadline: '2026-01-19',
        withdrawal_deadline: '2026-03-19',
        status: 'upcoming',
        is_current: false,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      },
      {
        ...
        add_drop_deadline: '2025-05-19',
        withdrawal_deadline: '2025-07-14',
        status: 'completed',
        is_current: false,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
    ...
    return [
      {
        ...
        name: 'Spring 2026 - Health Care Assistant',
      ...
      },
      {
        ...
        program_type: 'Certificate',
        name: 'Fall 2025 - Education Assistant',
