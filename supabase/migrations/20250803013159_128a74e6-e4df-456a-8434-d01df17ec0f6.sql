...
VALUES 
  ('564dedbf-1214-423e-bce6-eb95d26fc662'::uuid, 'John', 'Doe', 'john.doe@example.com', 'new', 'website', 'high', now() - interval '1 hour'),
  ('564dedbf-1214-423e-bce6-eb95d26fc662'::uuid, 'Jane', 'Smith', 'jane.smith@example.com', 'new', 'facebook', 'medium', now() - interval '2 hours'),
  ('564dedbf-1214-423e-bce6-eb95d26fc662'::uuid, 'Mike', 'Johnson', 'mike.j@example.com', 'contacted', 'google', 'low', now() - interval '1 day');
