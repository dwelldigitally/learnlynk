...
('Bachelor of Computer Science', 'undergraduate', 'A comprehensive 4-year program covering software development, algorithms, and computer systems', '4 years', 
 (SELECT auth.uid()), 
 '{"domestic_fee": 25000, "international_fee": 45000, "payment_plans": [{"name": "Full Payment", "discount": 5}, {"name": "Semester Payment", "installments": 8}]}',
 '{"academic": {"min_gpa": 3.0, "subjects": ["Mathematics", "English"]}, "language": {"ielts": 6.5, "toefl": 79}}',
 '[{"name": "Transcripts", "mandatory": true, "formats": ["PDF"]}, {"name": "Passport", "mandatory": true, "formats": ["PDF", "JPG"]}]'),
('Master of Business Administration', 'postgraduate', 'Advanced business leadership and management program', '2 years',
 (SELECT auth.uid()),
 '{"domestic_fee": 35000, "international_fee": 55000, "payment_plans": [{"name": "Full Payment", "discount": 10}, {"name": "Semester Payment", "installments": 4}]}',
 '{"academic": {"min_gpa": 3.5, "work_experience": 2}, "language": {"ielts": 7.0, "toefl": 100}}',
 '[{"name": "Degree Certificate", "mandatory": true, "formats": ["PDF"]}, {"name": "Work Experience Letter", "mandatory": true, "formats": ["PDF"]}]'),
('Certificate in Digital Marketing', 'certificate', 'Short-term program focusing on digital marketing strategies', '6 months',
 (SELECT auth.uid()),
 '{"domestic_fee": 8000, "international_fee": 12000, "payment_plans": [{"name": "Full Payment", "discount": 15}, {"name": "Monthly Payment", "installments": 6}]}',
 '{"academic": {"min_qualification": "High School"}, "language": {"ielts": 6.0, "toefl": 70}}',
 '[{"name": "High School Certificate", "mandatory": true, "formats": ["PDF"]}, {"name": "ID Document", "mandatory": true, "formats": ["PDF", "JPG"]}]');
...
SELECT 
  ...
  s.user_id,
  '[{"name": "Academic Transcripts", "status": "submitted", "required": true}, {"name": "English Proficiency", "status": "pending", "required": true}]',
  '[{"name": "transcript.pdf", "status": "approved", "uploaded_date": "2024-01-15"}, {"name": "passport.pdf", "status": "pending", "uploaded_date": "2024-01-20"}]'
