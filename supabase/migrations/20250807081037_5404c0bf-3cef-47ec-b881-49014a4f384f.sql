...
-- Insert sample data for master campuses (corrected structure)
...
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Main Campus', 'MAIN', '123 University Avenue', 'Toronto', 'Ontario', 'Canada', 'M5S 3M2', '+1-416-555-0123', 'main@university.edu', 'https://main.university.edu', 'America/Toronto', true, 5000, '["Library", "Computer Labs", "Student Center", "Cafeteria"]'::text[]),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Downtown Campus', 'DOWN', '456 Business District', 'Toronto', 'Ontario', 'Canada', 'M5H 1M1', '+1-416-555-0124', 'downtown@university.edu', 'https://downtown.university.edu', 'America/Toronto', true, 2000, '["Meeting Rooms", "Executive Lounge", "Parking"]'::text[]),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Scarborough Campus', 'SCAR', '789 Suburban Road', 'Scarborough', 'Ontario', 'Canada', 'M1B 5K7', '+1-416-555-0125', 'scarborough@university.edu', 'https://scarborough.university.edu', 'America/Toronto', true, 3000, '["Library", "Study Rooms", "Parking"]'::text[]);
...
('564dedbe-1214-423e-bce6-eb95d26fc662', 'High School Transcript', 'academic', 'transcripts', 'Official high school transcripts or equivalent', true, 10, '["pdf", "jpg", "png"]'::text[], 'application', '["All Programs"]'::text[], 'Submit official transcripts from your high school or equivalent institution. Documents must be in English or accompanied by certified translation.', '["transcript_sample.pdf"]'::text[], false),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Passport Copy', 'identification', 'identity', 'Clear copy of passport biographical page', true, 5, '["pdf", "jpg", "png"]'::text[], 'application', '["All Programs"]'::text[], 'Provide a clear, legible copy of your passport biographical page. Ensure all information is visible.', '["passport_sample.jpg"]'::text[], false),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'English Proficiency Test', 'language', 'language_proof', 'IELTS, TOEFL, or equivalent English test results', true, 5, '["pdf"]'::text[], 'application', '["BSC-CS", "MBA"]'::text[], 'Submit official English proficiency test results. Minimum scores: IELTS 6.5, TOEFL 79.', '["ielts_sample.pdf", "toefl_sample.pdf"]'::text[], false),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Statement of Purpose', 'academic', 'essays', 'Personal statement explaining motivation and goals', true, 2, '["pdf", "doc", "docx"]'::text[], 'application', '["MBA"]'::text[], 'Write a 500-800 word statement explaining your motivation, career goals, and why you chose this program.', '["sop_sample.pdf"]'::text[], false),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Work Experience Letter', 'professional', 'experience', 'Letter from employer confirming work experience', false, 5, '["pdf", "jpg", "png"]'::text[], 'application', '["MBA", "CDM"]'::text[], 'Provide letter from current or previous employer confirming your work experience, role, and duration.', '["work_letter_sample.pdf"]'::text[], false);
...
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Minimum Age', 'age', 'eligibility', 'Minimum age requirement for admission', '17', '65', 'years', true, '["All Programs"]'::text[], '["Birth Certificate", "Passport"]'::text[], 'document_verification', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'High School GPA', 'academic', 'grades', 'Minimum GPA from high school or equivalent', '2.5', '4.0', 'GPA', true, '["BSC-CS", "MBA"]'::text[], '["Official Transcripts"]'::text[], 'transcript_verification', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'English Proficiency', 'language', 'language_skills', 'Minimum English language proficiency', '6.5', '9.0', 'IELTS', true, '["BSC-CS", "MBA"]'::text[], '["IELTS", "TOEFL", "PTE"]'::text[], 'test_score_verification', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Work Experience', 'experience', 'professional', 'Minimum work experience required', '2', '10', 'years', true, '["MBA"]'::text[], '["Work Experience Letter", "Resume"]'::text[], 'employer_verification', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Computer Literacy', 'technical', 'skills', 'Basic computer and internet skills', '', '', '', false, '["CDM"]'::text[], '["Self Declaration"]'::text[], 'self_declaration', true);
...
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Admissions Team', 'internal', 'Main admissions and enrollment team', '["undergraduate", "postgraduate"]'::text[], 'Central', 25, '{"monday": "9:00-17:00", "tuesday": "9:00-17:00", "wednesday": "9:00-17:00", "thursday": "9:00-17:00", "friday": "9:00-17:00"}'::jsonb, '{"conversion_rate": 15.5, "avg_response_time": 4.2}'::jsonb, 'admissions@university.edu', '+1-416-555-0100', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'International Team', 'internal', 'Specialized team for international students', '["international", "visa_support"]'::text[], 'Central', 20, '{"monday": "8:00-18:00", "tuesday": "8:00-18:00", "wednesday": "8:00-18:00", "thursday": "8:00-18:00", "friday": "8:00-18:00"}'::jsonb, '{"conversion_rate": 12.3, "avg_response_time": 6.1}'::jsonb, 'international@university.edu', '+1-416-555-0101', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Business Programs Team', 'internal', 'Dedicated team for business and MBA programs', '["business", "MBA", "executive"]'::text[], 'Downtown', 15, '{"monday": "8:00-19:00", "tuesday": "8:00-19:00", "wednesday": "8:00-19:00", "thursday": "8:00-19:00", "friday": "8:00-17:00"}'::jsonb, '{"conversion_rate": 18.7, "avg_response_time": 3.5}'::jsonb, 'business@university.edu', '+1-416-555-0102', true),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Online Programs Team', 'internal', 'Team handling online and distance learning programs', '["online", "distance_learning", "certificates"]'::text[], 'Remote', 30, '{"monday": "7:00-19:00", "tuesday": "7:00-19:00", "wednesday": "7:00-19:00", "thursday": "7:00-19:00", "friday": "7:00-17:00"}'::jsonb, '{"conversion_rate": 13.2, "avg_response_time": 5.8}'::jsonb, 'online@university.edu', '+1-416-555-0103', true);
...
('564dedbe-1214-423e-bce6-eb95d26fc662', 'New Lead Alert', 'email', '["lead_created", "form_submitted"]'::text[], '{"source": ["website", "google_ads"], "priority": ["high", "critical"]}'::jsonb, '["admissions_team", "team_lead"]'::text[], 'new_lead_template', true, 'immediate'),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'High Priority Lead SMS', 'sms', '["lead_created"]'::text[], '{"priority": ["critical"], "program_interest": ["MBA"]}'::jsonb, '["senior_counselor", "director"]'::text[], 'urgent_lead_sms', true, 'immediate'),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Application Status Updates', 'email', '["application_submitted", "documents_received", "payment_completed"]'::text[], '{"stage": ["application", "documents", "payment"]}'::jsonb, '["student", "assigned_counselor"]'::text[], 'status_update_template', true, 'immediate'),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Daily Lead Summary', 'email', '["daily_summary"]'::text[], '{"team": ["all"]}'::jsonb, '["team_leads", "management"]'::text[], 'daily_summary_template', true, 'daily'),
('564dedbe-1214-423e-bce6-eb95d26fc662', 'Enrollment Milestone', 'slack', '["enrollment_completed", "payment_received"]'::text[], '{"program": ["MBA", "BSC-CS"], "amount": ">5000"}'::jsonb, '["sales_team", "finance_team"]'::text[], 'enrollment_celebration', true, 'immediate');
