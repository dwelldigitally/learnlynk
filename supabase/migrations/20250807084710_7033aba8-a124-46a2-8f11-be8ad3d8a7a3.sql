...
(get_demo_user_id(), 'Photo ID', 'Identification', 'Identity', 'Government-issued photo identification', 'Enrollment', true, ARRAY['PDF', 'JPG', 'PNG'], 2097152, 'Please provide a clear photo of your government-issued ID (driver''s license, passport, or state ID).', ARRAY[]::text[], ARRAY['BCS001', 'MBA002', 'CDM003'], false, true, 0);
