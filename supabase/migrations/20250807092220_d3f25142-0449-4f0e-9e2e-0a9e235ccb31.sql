-- Insert sample campuses (using correct column names)
INSERT INTO public.master_campuses (name, code, address, city, state, country, postal_code, phone, email, website, is_active, capacity, facilities, user_id) VALUES
('Main Campus', 'MAIN', '123 University Ave', 'Springfield', 'IL', 'USA', '62701', '(555) 123-4567', 'main@university.edu', 'https://main.university.edu', true, 5000, ARRAY['Library', 'Labs', 'Cafeteria', 'Gym'], auth.uid()),
('North Campus', 'NORTH', '456 College Blvd', 'Springfield', 'IL', 'USA', '62702', '(555) 234-5678', 'north@university.edu', 'https://north.university.edu', true, 3000, ARRAY['Library', 'Student Center', 'Parking'], auth.uid()),
('Online Campus', 'ONLINE', 'Online Only', 'Springfield', 'IL', 'USA', '62701', '(555) 345-6789', 'online@university.edu', 'https://online.university.edu', true, 10000, ARRAY['Virtual Classrooms', 'Digital Library'], auth.uid());
