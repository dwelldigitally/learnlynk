-- Create dummy data for enrollment optimization system

-- First, let's check if we need to temporarily disable RLS for seeding
...
INSERT INTO action_queue (
  ...
  suggested_action, sla_due_at, status, priority, created_at
) VALUES 
...
-- Re-enable RLS (these policies should be created to secure the data properly)
...
-- Create RLS policies to allow all users to see this demo data for now
-- Note: In production, these should be restricted to appropriate user roles
